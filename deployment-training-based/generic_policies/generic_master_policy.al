...
#   -> create ledger table
#-----------------------------------------------------------------------------------------------------------------------
# process !training_scripts/generic_policies/generic_master_policy.al
on error ignore
...
<new_policy = {
    "config": {
        ...
        "script": [
            ...
            "if not !is_policy then process !training_scripts/generic_policies/publish_policy.al",
...
:sign-policy-error:
print 'Failed to sign (generic) master policy'
goto terminate-scripts

:prepare-policy-error:
print 'Failed to prepare (generic) master policy for publishing on blockchain'
goto terminate-scripts

:declare-policy-error:
print 'Failed to declare (generic) master policy on blockchain'
goto terminate-scripts
