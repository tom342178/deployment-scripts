...
if !broker_bind == true and !overlay_ip then set policy new_policy [query][broker_ip] = !overlay_ip
else if !broker_bind == true and not !overlay_ip then set policy new_policy [query][broker_ip] = !ip
