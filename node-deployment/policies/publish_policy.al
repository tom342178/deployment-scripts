...
if !blockchain_destination == master then blockchain insert where policy=!new_policy and local=true and master=!ledger_conn
else blockchain insert where policy=!new_policy and local=true and blockchain=!platform
